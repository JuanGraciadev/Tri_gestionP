...
<body class="font-sans antialiased text-slate-800 min-h-screen">
    ...
    <div class="flex min-h-screen relative z-10">
        ...
        <!-- ═══ SIDEBAR TRABAJADOR (Rol 2 original) ═══ -->
        <aside class="w-72 bg-gradient-to-b from-trigestion-800 via-trigestion-900 to-slate-950 text-white flex flex-col fixed inset-y-0 left-0 z-30 shadow-2xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-6 overflow-y-auto">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('trabajador.dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-extrabold bg-sky-500/30 text-white border-l-4 border-sky-400 shadow-md backdrop-blur-sm">
